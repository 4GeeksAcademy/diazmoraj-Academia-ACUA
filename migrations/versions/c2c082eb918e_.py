...
Revision ID: c2c082eb918e
Revises: 
Create Date: 2024-06-20 02:20:53.865467
...
def upgrade():
    ...
    sa.Column('cardID_type', sa.String(length=50), nullable=False),
    sa.Column('number_cardID', sa.Integer(), nullable=False),
    sa.Column('birthday', sa.Date(), nullable=False),
    sa.Column('email', sa.String(length=50), nullable=False),
    sa.Column('phone_number', sa.Integer(), nullable=False),
    sa.Column('province', sa.String(length=50), nullable=False),
    sa.Column('canton', sa.String(length=50), nullable=False),
    sa.Column('distric', sa.String(length=50), nullable=False),
    ...
    sa.Column('phone_number', sa.Integer(), nullable=False),
    sa.Column('iban_acount', sa.Integer(), nullable=False),
    sa.Column('professor_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['professor_id'], ['professor.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('iban_acount')
    )
