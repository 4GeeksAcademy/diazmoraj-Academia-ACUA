...
const InfoAdmin = () => {
  ...
  const navigate = useNavigate()
    ...
    const handleSubmit = async () => {
        ...
        const isCreated = await actions.newAdministrator(formData)
        console.log(isCreated)
        if (isCreated) {
            showNotification("Administrador creado con éxito")
            navigate("/homeadmin")
        } else {
            showNotification("Ocurrió un error al tratar de agregar el adminsitrador", "error")
        }
    }
    return (
          ...
          <div className="d-flex mb-2 align-items-center">
            ...
            <div className="d-flex flex-column align-items-center position-relative">
              ...
              <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"
                alt="Foto de perfil" className="mb-1" style={{ width: '150px', height: '150px' }} onClick={handleInputChange}/>
